...
2. Navigate to **Settings** -> **Packages** (or **Tools** depending on your VCC version) -> **Add Repository**.
3. Enter the repository URL for this plugin: `https://sebane1.github.io/VRCSlimeVRToeRigSupport/index.json`
